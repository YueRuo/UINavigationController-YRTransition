...
typedef NS_ENUM(NSUInteger, YRTransitonStyle) {
    ...
    YRTransitonStyle_YRVCRouter,//use YRVCRouter
};
...
NS_CLASS_AVAILABLE_IOS(7_0) @interface YRPercentDrivenInteractiveTransition : UIPercentDrivenInteractiveTransition
